  ...
  return (
    ...
    rounded-[16px] text-gray-98 font-robot">
        <div className="max-w-[375px] ">
            ...
            <div className="flex flex-col items-center max-w-[500px] border-2 border-[#24A0B5] p-6 overflow-hidden"
            style={
            {borderBottomStyle: "none"}
                ...
                <div className="flex flex-col justify-center items-center text-gray-98 font-roboto">
                    <div className='flex flex-col justify-center items-center gap-2 mt-6 p-6'>
            ...
            <div className="flex justify-center  min-w-[284px] border-2 border-[#24A0B5]"
                style={{ borderTopStyle: "dashed" }}>
                <img className="w-[100px] h-[100px]" src={BarCode} alt="" />
            </div>
